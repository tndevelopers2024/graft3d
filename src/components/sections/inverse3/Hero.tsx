...
const Hero = () => {
    return (
        <section className="relative w-full overflow-hidden bg-gradient-to-br from-[#DCEAF4] via-[#EAF3FA] to-[#F4FAFD]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-8 items-center">
                    ...
                    <div className="flex flex-col">
                        <h1 className="text-5xl sm:text-6xl lg:text-[70px] lg:leading-[1.02] font-bold tracking-tight">
                            <span className="text-[#2A2A2A]">Inverse</span>
                            <span className="text-[#166AAF]">3</span>
                        </h1>

                        <h2 className="mt-4 text-2xl sm:text-3xl lg:text-[38px] lg:leading-[1.18] font-medium text-[#2A2A2A]">
                            Precision Haptics. Real-World Feel.{" "}
                            <span className="text-[#166AAF]">Digital Control.</span>
                        </h2>

                        <p className="mt-5 max-w-xl text-[#2A2A2A]/90 text-[15px] lg:text-base leading-relaxed">
                            Step into a new dimension of interaction with Inverse3. A high-performance
                            3D haptic device engineered for precision and seamless integration.
                            Inverse3 delivers ultra-fine force feedback and motion control, enabling
                            users to feel and manipulate digital environments with unmatched realism.
                            From surgical simulations to robotics and virtual prototyping, Inverse3
                    ...
                    {/* Right: contact + product visual */}
                    <div className="flex flex-col">
                        <div className="flex flex-col sm:flex-row lg:justify-end gap-6 sm:gap-10">
                        ...
                        <div className="relative w-full h-[320px] sm:h-[420px] lg:h-[460px] mt-2">
                            <Image
                                src="/images/inverse3/device.png"
                                alt="Inverse3 articulated 3D haptic device with VerseGrip stylus"
                                fill
                                priority
